 ...
 */
 ...
 // Special for interfacing to Python
SUNDIALS_EXPORT realtype N_VGetNthElement (N_Vector x, sunindextype index);
SUNDIALS_EXPORT void N_VSetNthElement (N_Vector x, sunindextype index, realtype value);
